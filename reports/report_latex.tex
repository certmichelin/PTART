...
\newcommand{\client}{\VAR{project.client}}
...
\BLOCK{ for host in project.host_set.all() }
	\subsection{\VAR{ host.ip } - \VAR{host.hostname}}
	...
	\BLOCK{ for service in host.service_set.all() }
		\subsubsection{Port \VAR{service.port} - \VAR{service.protocol}}
