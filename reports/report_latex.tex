				...
				\begin{table}[H]
					...
					\begin{tabular}{| l | p{12cm} |}
						...
						\BLOCK{ if hit.get_cvss_value() == "---" }
							CVSSv3 Base Score & \badge[cvss3-badge-secondary]{ N.C } \\
						\BLOCK{ elif hit.get_cvss_value() <= 0 }
							CVSSv3 Base Score & \badge[cvss3-badge-secondary]{\VAR{ hit.get_cvss_value()} - None} \\
						\BLOCK{ elif hit.get_cvss_value() <= 4.0 }
							CVSSv3 Base Score & \badge[cvss3-badge-success]{\VAR{ hit.get_cvss_value()} - Low} \\
						\BLOCK{ elif hit.get_cvss_value() <= 7.0 }
							CVSSv3 Base Score & \badge[cvss3-badge-warning]{\VAR{ hit.get_cvss_value()} - Medium} \\
						\BLOCK{ elif hit.get_cvss_value() <= 9.0 }
							CVSSv3 Base Score & \badge[cvss3-badge-danger]{\VAR{ hit.get_cvss_value()} - High} \\
						\BLOCK{ else }
							CVSSv3 Base Score & \badge[cvss3-badge-dark]{\VAR{ hit.get_cvss_value()} - Critical} \\
						\BLOCK{ endif }
						\hline
						CVSSv3 String &  \VAR{ hit.get_cvss_string() } \\
						\BLOCK{ else }
						\BLOCK{ if hit.get_cvss_value() == "---" }
							CVSSv4 Base Score & \badge[cvss4-badge-secondary]{ N.C } \\
						\BLOCK{ elif hit.get_cvss_value() <= 0 }
							CVSSv4 Base Score & \badge[cvss4-badge-secondary]{\VAR{ hit.get_cvss_value()} - None} \\
						\BLOCK{ elif hit.get_cvss_value() <= 4.0 }
							CVSSv4 Base Score & \badge[cvss4-badge-success]{\VAR{ hit.get_cvss_value()} - Low} \\
						\BLOCK{ elif hit.get_cvss_value() <= 7.0 }
							CVSSv4 Base Score & \badge[cvss4-badge-warning]{\VAR{ hit.get_cvss_value()} - Medium} \\
						\BLOCK{ elif hit.get_cvss_value() <= 9.0 }
							CVSSv4 Base Score & \badge[cvss4-badge-danger]{\VAR{ hit.get_cvss_value()} - High} \\
						\BLOCK{ else }
							CVSSv4 Base Score & \badge[cvss4-badge-dark]{\VAR{ hit.get_cvss_value()} - Critical} \\
						\BLOCK{ endif }
						\hline
	...
	\BLOCK{ for retestcampaign in project.retestcampaign_set.all() }
		...
		\subsubsection{\VAR{ retest_hit.hit.get_unique_id()} - \VAR{retest_hit.hit.title | escape }}
				...
				\begin{table}[H]
					...
					\begin{tabular}{| l | p{12cm} |}
						\hline 
						Severity & \badge[bc-badge-p\VAR{ retest_hit.hit.severity }]{P\VAR{ retest_hit.hit.severity }}\\
						\hline
						\BLOCK{ if project.cvss_type == 3 }
						\BLOCK{ if retest_hit.hit.get_cvss_value() == "---" }
							CVSSv3 Base Score & \badge[cvss3-badge-secondary]{ N.C } \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 0 }
							CVSSv3 Base Score & \badge[cvss3-badge-secondary]{\VAR{ retest_hit.hit.get_cvss_value()} - None} \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 4.0 }
							CVSSv3 Base Score & \badge[cvss3-badge-success]{\VAR{ retest_hit.hit.get_cvss_value()} - Low} \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 7.0 }
							CVSSv3 Base Score & \badge[cvss3-badge-warning]{\VAR{ retest_hit.hit.get_cvss_value()} - Medium} \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 9.0 }
							CVSSv3 Base Score & \badge[cvss3-badge-danger]{\VAR{ retest_hit.hit.get_cvss_value()} - High} \\
						\BLOCK{ else }
							CVSSv3 Base Score & \badge[cvss3-badge-dark]{\VAR{ retest_hit.hit.get_cvss_value()} - Critical} \\
						\BLOCK{ endif }
						\hline
						...
						\BLOCK{ if retest_hit.hit.get_cvss_value() == "---" }
							CVSSv4 Base Score & \badge[cvss4-badge-secondary]{ N.C } \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 0 }
							CVSSv4 Base Score & \badge[cvss4-badge-secondary]{\VAR{ retest_hit.hit.get_cvss_value()} - None} \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 4.0 }
							CVSSv4 Base Score & \badge[cvss4-badge-success]{\VAR{ retest_hit.hit.get_cvss_value()} - Low} \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 7.0 }
							CVSSv4 Base Score & \badge[cvss4-badge-warning]{\VAR{ retest_hit.hit.get_cvss_value()} - Medium} \\
						\BLOCK{ elif retest_hit.hit.get_cvss_value() <= 9.0 }
							CVSSv4 Base Score & \badge[cvss4-badge-danger]{\VAR{ retest_hit.hit.get_cvss_value()} - High} \\
						\BLOCK{ else }
							CVSSv4 Base Score & \badge[cvss4-badge-dark]{\VAR{ retest_hit.hit.get_cvss_value()} - Critical} \\
						\BLOCK{ endif }
						\hline
						CVSSv4 String &  {\small \VAR{ retest_hit.hit.get_cvss_string() }} \\
						\BLOCK{ endif }
						\hline
						Status & \badge[retest-status-\VAR{ retest_hit.status }]{\VAR{ retest_hit.get_status_display()}} \\
						\hline  
						Fix Complexity & \badge[fix-complexity-\VAR{ retest_hit.hit.fix_complexity }]{\VAR{ retest_hit.hit.get_fix_complexity_str()}} \\
						\hline 
						Asset & \VAR{ retest_hit.hit.asset | escape  } \\
						\hline 
						Label(s) &  \BLOCK{ for label in retest_hit.hit.labels.all() } \badge[label-color-\VAR{ label.id }]{\VAR{ label.title }}\BLOCK{ endfor } \\	
						\hline 
