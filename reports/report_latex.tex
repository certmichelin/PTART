			...
			\BLOCK{ for hit in assessment.displayable_hits() }
				...
				\begin{table}[H]
					...
					\begin{tabular}{| l | p{12cm} |}
						...
						\hline 
						CWE(s) &  \BLOCK{ for cwe in hit.cwes.all() } \badge[cwe]{\footnotesize \VAR{ cwe | mdtolatex }}\BLOCK{ endfor } \\
						\hline
		...
		\subsubsection{\VAR{ retest_hit.hit.get_unique_id()} - \VAR{retest_hit.hit.title | escape }}
				...
				\begin{table}[H]
					...
					\begin{tabular}{| l | p{12cm} |}
						...
						\hline 
						CWE(s) &  \BLOCK{ for cwe in retest_hit.hit.cwes.all() } \badge[cwe]{\footnotesize \VAR{ cwe }}\BLOCK{ endfor } \\
						\hline 
