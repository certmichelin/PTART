			...
			\BLOCK{ for hit in assessment.displayable_hits() }
				...
				\begin{table}[H]
					...
					\begin{tabular}{| l | p{12cm} |}
						...
						\hline 
						CWE(s) &  \BLOCK{ for cwe in hit.cwes.all() } \badge[cwe]{\footnotesize \VAR{ cwe.print_cwe() | mdtolatex }}\BLOCK{ endfor } \\
						\hline
		...
		\subsubsection{\VAR{ retest_hit.hit.get_unique_id()} - \VAR{retest_hit.hit.title | escape }}
				...
				\begin{table}[H]
					...
					\begin{tabular}{| l | p{12cm} |}
						...
						\hline 
						CWE(s) &  \BLOCK{ for cwe in retest_hit.hit.cwes.all() } \badge[cwe]{\footnotesize \VAR{ cwe.print_cwe() | mdtolatex }}\BLOCK{ endfor } \\
						\hline 
...
\BLOCK{ for cwe in project.cwes_used() }
	\subsection{\VAR{ cwe.print_cwe() | mdtolatex }}
	\VAR{ cwe.description | mdtolatex }
	\VAR{ cwe.extended_description | mdtolatex }
\BLOCK{ endfor }
\BLOCK{ endif } 
