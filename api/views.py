                        ...
                        "hits": [
                            {
                                ...
                                "cvss_vector": (
                                    ...
                                    else hit.cvss4.get_cvss_string()
                                ),
                                "cvss_score": (
                                    hit.cvss3.decimal_value
                                    if project.cvss_type == 3
                                    else hit.cvss4.decimal_value
                                ),
                        ...
                        "hits": [
                            {
                                ...
                                "original_hit": {
                                    ...
                                    "cvss_vector": (
                                        ...
                                        if project.cvss_type == 3
                                        else retesthit.hit.cvss4.get_cvss_string()
                                    ),
                                    "cvss_score": (
                                        retesthit.hit.cvss3.decimal_value
                                        if project.cvss_type == 3
                                        else retesthit.hit.cvss4.decimal_value
                                    ),
                                    "labels": [
                                        label.title
                                        for label in retesthit.hit.labels.all()
                                    ],
                                },
                                "screenshots": [
                                    {
