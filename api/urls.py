...
urlpatterns = [
    ...
    url(r'^hit/(?P<pk>[0-9]+)/cvss3/$', views.cvss3_hit),
    url(r'^hit/(?P<pk>[0-9]+)/cvss4/$', views.cvss4_hit),
    url(r'^hit/(?P<pk>[0-9]+)/comments/$', views.comments),
    url(r'^hit/(?P<pk>[0-9]+)/references/$', views.hit_references),
    url(r'^hits/$', views.hits),
    url(r'^label/(?P<pk>[0-9]+)/$', views.label),
    url(r'^labels/$', views.labels),
    url(r'^tool/(?P<pk>[0-9]+)/$', views.tool),
    ...
    url(r'^cvss3/$', views.cvss3),
    url(r'^cvss4/$', views.cvss4),
